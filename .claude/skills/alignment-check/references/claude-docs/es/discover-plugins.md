---
source_url: https://code.claude.com/docs/es/discover-plugins
fetched_url: https://code.claude.com/docs/es/discover-plugins.md
category: Crear con Claude Code, agentes y automatizacion
status: 200
scraped_at: 2026-05-15T14:27:42+00:00
sha256_16: a5f478e8b09afc63
sanitized: true
---
...
<Steps>
  ...
  <Step title="Usar su nuevo plugin">
    ...
    Cada plugin funciona de manera diferente. Consulte la descripción del plugin en la pestaña **Discover** o su página de inicio para aprender qué skills y capacidades proporciona.
  </Step>
</Steps>
