---
source_url: https://code.claude.com/docs/es/agent-sdk/hosting
fetched_url: https://code.claude.com/docs/es/agent-sdk/hosting.md
category: SDK de Agente
status: 200
scraped_at: 2026-05-15T14:28:44+00:00
sha256_16: c0569ac8053e38f8
sanitized: true
---
...
<Info>
  Para endurecimiento de seguridad más allá del sandboxing básico (incluidos controles de red, gestión de credenciales y opciones de aislamiento), consulte [Implementación Segura](/es/agent-sdk/secure-deployment).
</Info>
...
El SDK también admite [configuración de sandbox programática](/es/agent-sdk/typescript#sandbox-settings) para la ejecución de comandos.
...
Para opciones autohospedadas (Docker, gVisor, Firecracker) y configuración de aislamiento detallada, consulte [Tecnologías de Aislamiento](/es/agent-sdk/secure-deployment#isolation-technologies).
...
### ¿Cuándo debo apagar contenedores inactivos frente a mantenerlos activos?
...
### ¿Con qué frecuencia debo actualizar la CLI de Claude Code?
...
### ¿Cuánto tiempo puede ejecutarse una sesión de agente antes de agotar el tiempo?
...
* [Implementación Segura](/es/agent-sdk/secure-deployment) - Controles de red, gestión de credenciales y endurecimiento de aislamiento
* [SDK de TypeScript - Configuración de Sandbox](/es/agent-sdk/typescript#sandbox-settings) - Configurar sandbox programáticamente
* [Guía de Sesiones](/es/agent-sdk/sessions) - Aprenda sobre la gestión de sesiones
* [Permisos](/es/agent-sdk/permissions) - Configurar permisos de herramientas
* [Seguimiento de Costos](/es/agent-sdk/cost-tracking) - Monitorear el uso de API
* [Integración MCP](/es/agent-sdk/mcp) - Extender con herramientas personalizadas
