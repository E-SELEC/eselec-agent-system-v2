---
source_url: https://code.claude.com/docs/es/agent-sdk/overview
fetched_url: https://code.claude.com/docs/es/agent-sdk/overview.md
category: SDK de Agente
status: 200
scraped_at: 2026-05-15T14:28:24+00:00
sha256_16: bee22df745e372cd
sanitized: true
---
...
<CardGroup cols={2}>
  <Card title="Inicio rápido" icon="play" href="/es/agent-sdk/quickstart">
...
**¿Listo para construir?** Siga el [Inicio rápido](/es/agent-sdk/quickstart) para crear un agente que encuentre y corrija errores en minutos.
...
<Tabs>
  <Tab title="Herramientas integradas">
    ...
    | **[AskUserQuestion](/es/agent-sdk/user-input#handle-clarifying-questions)** | Hacer preguntas aclaratorias al usuario con opciones de opción múltiple        |
  ...
  <Tab title="Hooks">
    ...
    **Hooks disponibles:** `PreToolUse`, `PostToolUse`, `Stop`, `SessionStart`, `SessionEnd`, `UserPromptSubmit` y más.
    ...
    [Obtenga más información sobre hooks →](/es/agent-sdk/hooks)
  </Tab>
  ...
  <Tab title="Subagentes">
    ...
    Defina agentes personalizados con instrucciones especializadas. Incluya `Agent` en `allowedTools` ya que los subagentes se invocan a través de la herramienta Agent:
    ...
    [Obtenga más información sobre subagentes →](/es/agent-sdk/subagents)
  </Tab>
  ...
  <Tab title="MCP">
    ...
    [Obtenga más información sobre MCP →](/es/agent-sdk/mcp)
  </Tab>
  ...
  <Tab title="Permisos">
    ...
    <Note>
      Para solicitudes de aprobación interactivas y la herramienta `AskUserQuestion`, consulte [Manejar aprobaciones e entrada del usuario](/es/agent-sdk/user-input).
    </Note>
    ...
    [Obtenga más información sobre permisos →](/es/agent-sdk/permissions)
  </Tab>
  ...
  <Tab title="Sesiones">
    ...
    [Obtenga más información sobre sesiones →](/es/agent-sdk/sessions)
  </Tab>
</Tabs>
...
| ------------------------------------------------ | -------------------------------------------------------------- | -------------------------------------------- |
| [Skills](/es/agent-sdk/skills)                   | Capacidades especializadas definidas en Markdown               | `.claude/skills/*/SKILL.md`                  |
| [Slash commands](/es/agent-sdk/slash-commands)   | Comandos personalizados para tareas comunes                    | `.claude/commands/*.md`                      |
| [Memory](/es/agent-sdk/modifying-system-prompts) | Contexto e instrucciones del proyecto                          | `CLAUDE.md` o `.claude/CLAUDE.md`            |
| [Plugins](/es/agent-sdk/plugins)                 | Extienda con comandos personalizados, agentes y servidores MCP | Programático a través de la opción `plugins` |
...
<CardGroup cols={2}>
  ...
  <Card title="TypeScript SDK" icon="code" href="/es/agent-sdk/typescript">
    Referencia completa de API de TypeScript y ejemplos
  </Card>

  <Card title="Python SDK" icon="code" href="/es/agent-sdk/python">
