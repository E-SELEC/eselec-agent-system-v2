---
source_url: https://code.claude.com/docs/es/server-managed-settings
fetched_url: https://code.claude.com/docs/es/server-managed-settings.md
category: Administracion
status: 200
scraped_at: 2026-05-15T14:27:54+00:00
sha256_16: c4cab57d76e2c0a4
sanitized: true
---
...
| El usuario configura un [proveedor de modelo de terceros](#platform-availability) | La configuración administrada por servidor se omite. Esto incluye establecer `CLAUDE_CODE_USE_BEDROCK`, `CLAUDE_CODE_USE_MANTLE`, `CLAUDE_CODE_USE_VERTEX`, `CLAUDE_CODE_USE_FOUNDRY`, o un `ANTHROPIC_BASE_URL` no predeterminado                                                                               |
