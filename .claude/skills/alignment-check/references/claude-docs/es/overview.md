---
source_url: https://code.claude.com/docs/es/overview
fetched_url: https://code.claude.com/docs/es/overview.md
category: Primeros pasos
status: 200
scraped_at: 2026-05-15T14:27:18+00:00
sha256_16: 8fa6c5a858afbe67
sanitized: true
---
...
<AccordionGroup>
  ...
  <Accordion title="Personaliza con instrucciones, skills y hooks" icon="sliders">
    ...
    Crea [skills](/es/skills) para empaquetar flujos de trabajo repetibles que tu equipo pueda compartir, como `/review-pr` o `/deploy-staging`.
