...
- `arquitecto`, `fenix`, `calibracion`, `loops-leader`, `bibliotecario`: gobernanza, regeneracion estructural, aprendizaje de Rodrigo, ciclos recurrentes y gestion de conocimiento.
